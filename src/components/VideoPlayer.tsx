  ...
  return (
    <div id="video-theater-stage" className="bg-[#1E293B] border border-slate-705 rounded-lg overflow-hidden shadow-2xl flex flex-col lg:flex-row text-slate-100 max-w-full">
      ...
      <div className="flex-1 bg-black flex flex-col relative group min-h-[280px] sm:min-h-[380px] lg:min-h-[440px]">
        ...
        <div className="relative flex-1 flex items-center justify-center overflow-hidden h-full">
          ...
          {autoplayBlocked && (
            <div className="absolute inset-0 z-30 flex items-center justify-center">
              <div className="bg-black/80 text-center p-4 rounded-lg">
                <p className="text-sm font-semibold text-white">Autoplay blocked by browser</p>
                <p className="text-xs text-slate-300 mt-1">Click to allow playback</p>
                <div className="mt-3">
                  <button
                    onClick={async () => {
                      if (!videoRef.current) return;
        ...
        <div className="p-3 bg-[#0F172A] border-t border-slate-700 flex flex-wrap items-center justify-between gap-3 text-xs select-none">
      ...
      <div className="w-full lg:w-[325px] bg-[#151d2e] border-t lg:border-t-0 lg:border-l border-slate-700 p-4 flex flex-col justify-between max-h-[550px] lg:max-h-none overflow-y-auto shadow-inner">
